...
[![Tests](https://img.shields.io/badge/tests-396%20pytest%20%2B%2027%20vitest-green)]()
...
| **Tests** | Pytest + Vitest | 396 tests (backend+display) + 27 frontend |
...
Estado verificado por CI (2026-08-20): **396 tests** (pytest, backend + display) y **27 tests** de frontend (Vitest).
